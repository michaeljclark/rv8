...
struct riscv_emulator
{
	...
	/*
		This simple proof of concept machine emulator used a machine
		generated interpreter interpreter in src/asm/riscv-interp.h
		generated by parse-meta from C-psuedo code in meta/instructions
	*/
