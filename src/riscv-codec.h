...
namespace riscv
{
	...
	/* Decode none */
	template <typename T>
	inline void decode_none(T &dec, uint64_t inst)
	{
	...
	/* Decode C nop */
	template <typename T>
	inline void decode_ci_none(T &dec, uint64_t inst)
	{
		dec.rd = dec.rs1 = dec.rs2 = riscv_ireg_zero;
		dec.imm = 0;
	}
	...
	/* Decode CR */
	template <typename T>
	inline void decode_cr(T &dec, uint64_t inst)
	{
	...
	/* Decode CR mv */
	template <typename T>
	inline void decode_cr_mv(T &dec, uint64_t inst)
	{
	...
	/* Decode CR jalr */
	template <typename T>
	inline void decode_cr_jalr(T &dec, uint64_t inst)
	{
	...
	/* Decode CR jr */
	template <typename T>
	inline void decode_cr_jr(T &dec, uint64_t inst)
	{
	...
	/* Decode CI */
	template <typename T>
	inline void decode_ci(T &dec, uint64_t inst)
	{
		dec.rd = dec.rs1 = arg_crs1rd::decode(inst);
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode CI shamt5 */
	template <typename T>
	inline void decode_ci_sh5(T &dec, uint64_t inst)
	{
		dec.rd = dec.rs1 = arg_crs1rd::decode(inst);
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode CI shamt6 */
	template <typename T>
	inline void decode_ci_sh6(T &dec, uint64_t inst)
	{
		dec.rd = dec.rs1 = arg_crs1rd::decode(inst);
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode CI li */
	template <typename T>
	inline void decode_ci_li(T &dec, uint64_t inst)
	{
		dec.rd = arg_crd::decode(inst);
		dec.rs1 = riscv_ireg_zero;
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode CI lui */
	template <typename T>
	inline void decode_ci_lui(T &dec, uint64_t inst)
	{
		dec.rd = arg_crd::decode(inst);
		dec.rs1 = riscv_ireg_zero;
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode CI lwsp */
	template <typename T>
	inline void decode_ci_lwsp(T &dec, uint64_t inst)
	{
		dec.rd = arg_crd::decode(inst);
	...
	/* Decode CI ldsp */
	template <typename T>
	inline void decode_ci_ldsp(T &dec, uint64_t inst)
	{
		dec.rd = arg_crd::decode(inst);
		dec.rs1 = riscv_ireg_sp;
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode CI 16sp */
	template <typename T>
	inline void decode_ci_16sp(T &dec, uint64_t inst)
	{
	...
	/* Decode CSS swsp */
	template <typename T>
	inline void decode_css_swsp(T &dec, uint64_t inst)
	{
		dec.rd = riscv_ireg_zero;
		dec.rs1 = riscv_ireg_sp;
		dec.rs2 = arg_crs2::decode(inst);
	...
	/* Decode CSS sdsp */
	template <typename T>
	inline void decode_css_sdsp(T &dec, uint64_t inst)
	{
		dec.rd = riscv_ireg_zero;
		dec.rs1 = riscv_ireg_sp;
		dec.rs2 = arg_crs2::decode(inst);
	...
	/* Decode CIW 4spn */
	template <typename T>
	inline void decode_ciw_4spn(T &dec, uint64_t inst)
	{
	...
	/* Decode CL lw */
	template <typename T>
	inline void decode_cl_lw(T &dec, uint64_t inst)
	{
		dec.rd = arg_crdq::decode(inst) + 8;
	...
	/* Decode CL ld */
	template <typename T>
	inline void decode_cl_ld(T &dec, uint64_t inst)
	{
		dec.rd = arg_crdq::decode(inst) + 8;
		dec.rs1 = arg_crs1q::decode(inst) + 8;
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode CS f */
	template <typename T>
	inline void decode_cs(T &dec, uint64_t inst)
	{
	...
	/* Decode CS sd */
	template <typename T>
	inline void decode_cs_sd(T &dec, uint64_t inst)
	{
		dec.rd = riscv_ireg_zero;
		dec.rs1 = arg_crs1q::decode(inst) + 8;
		dec.rs2 = arg_crs2q::decode(inst) + 8;
	...
	/* Decode CS sw */
	template <typename T>
	inline void decode_cs_sw(T &dec, uint64_t inst)
	{
		dec.rd = riscv_ireg_zero;
		dec.rs1 = arg_crs1q::decode(inst) + 8;
		dec.rs2 = arg_crs2q::decode(inst) + 8;
	...
	/* Decode CB */
	template <typename T>
	inline void decode_cb(T &dec, uint64_t inst)
	{
		dec.rd = riscv_ireg_zero;
		dec.rs1 = arg_crs1q::decode(inst) + 8;
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode CB imm */
	template <typename T>
	inline void decode_cb_imm(T &dec, uint64_t inst)
	{
		dec.rd = dec.rs1 = arg_crs1rdq::decode(inst) + 8;
		dec.rs2 = riscv_ireg_zero;
		dec.imm = arg_cimmi::decode(inst);
	...
	/* Decode CB shamt5 */
	template <typename T>
	inline void decode_cb_sh5(T &dec, uint64_t inst)
	{
		dec.rd = dec.rs1 = arg_crs1rdq::decode(inst) + 8;
		dec.rs2 = riscv_ireg_zero;
		dec.imm = arg_cimmsh5::decode(inst);
	...
	/* Decode CB shamt6 */
	template <typename T>
	inline void decode_cb_sh6(T &dec, uint64_t inst)
	{
		dec.rd = dec.rs1 = arg_crs1rdq::decode(inst) + 8;
		dec.rs2 = riscv_ireg_zero;
		dec.imm = arg_cimmsh6::decode(inst);
	...
	/* Decode CJ - imm */
	template <typename T>
	inline void decode_cj(T &dec, uint64_t inst)
	{
		dec.rd = dec.rs1 = dec.rs2 = riscv_ireg_zero;
	...
	/* Decode R */
	template <typename T>
	inline void decode_r(T &dec, uint64_t inst)
	{
	...
	/* Decode R RM */
	template <typename T>
	inline void decode_r_m(T &dec, uint64_t inst)
	{
		dec.rd = arg_rd::decode(inst);
		dec.rs1 = arg_rs1::decode(inst);
		dec.rs2 = arg_rs2::decode(inst);
	...
	/* Decode R AMO L */
	template <typename T>
	inline void decode_r_l(T &dec, uint64_t inst)
	{
		dec.rd = arg_rd::decode(inst);
		dec.rs1 = arg_rs1::decode(inst);
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode R AMO S */
	template <typename T>
	inline void decode_r_a(T &dec, uint64_t inst)
	{
		dec.rd = arg_rd::decode(inst);
		dec.rs1 = arg_rs1::decode(inst);
		dec.rs2 = arg_rs2::decode(inst);
	...
	/* Decode R 4f */
	template <typename T>
	inline void decode_r4_m(T &dec, uint64_t inst)
	{
		dec.rd = arg_rd::decode(inst);
		dec.rs1 = arg_rs1::decode(inst);
		dec.rs2 = arg_rs2::decode(inst);
	...
	/* Decode I */
	template <typename T>
	inline void decode_i(T &dec, uint64_t inst)
	{
		dec.rd = arg_rd::decode(inst);
		dec.rs1 = arg_rs1::decode(inst);
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode I sh5 */
	template <typename T>
	inline void decode_i_sh5(T &dec, uint64_t inst)
	{
		dec.rd = arg_rd::decode(inst);
		dec.rs1 = arg_rs1::decode(inst);
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode I sh6 */
	template <typename T>
	inline void decode_i_sh6(T &dec, uint64_t inst)
	{
		dec.rd = arg_rd::decode(inst);
		dec.rs1 = arg_rs1::decode(inst);
		dec.rs2 = riscv_ireg_zero;
	...
	/* Decode S Store */
	template <typename T>
	inline void decode_s(T &dec, uint64_t inst)
	{
		dec.rd = riscv_ireg_zero;
		dec.rs1 = arg_rs1::decode(inst);
		dec.rs2 = arg_rs2::decode(inst);
	...
	/* Decode SB Branch */
	template <typename T>
	inline void decode_sb(T &dec, uint64_t inst)
	{
		dec.rd = riscv_ireg_zero;
		dec.rs1 = arg_rs1::decode(inst);
		dec.rs2 = arg_rs2::decode(inst);
	...
	/* Decode U */
	template <typename T>
	inline void decode_u(T &dec, uint64_t inst)
	{
		dec.rd = arg_rd::decode(inst);
	...
	/* Decode UJ */
	template <typename T>
	inline void decode_uj(T &dec, uint64_t inst)
	{
		dec.rd = arg_rd::decode(inst);
		dec.rs1 = dec.rs2 = riscv_ireg_zero;
	...
	/* Encode none */
	template <typename T>
	inline uint64_t encode_none(T &dec) { return 0; }

	/* Encode C nop */
	template <typename T>
	inline uint64_t encode_ci_none(T &dec)
	{
	...
	/* Encode CR */
	template <typename T>
	inline uint64_t encode_cr(T &dec)
	{
		assert(dec.rd == dec.rs1);
		return arg_crs1rd::encode(dec.rd) |
			arg_crs2::encode(dec.rs2);
	}

	/* Encode CR mv */
	template <typename T>
	inline uint64_t encode_cr_mv(T &dec)
	{
		assert(dec.rs1 == riscv_ireg_zero);
		return arg_crd::encode(dec.rd) |
			arg_crs2::encode(dec.rs2);
	}

	/* Encode CR jalr */
	template <typename T>
	inline uint64_t encode_cr_jalr(T &dec)
	{
	...
	/* Encode CR jr */
	template <typename T>
	inline uint64_t encode_cr_jr(T &dec)
	{
		assert(dec.rd == riscv_ireg_zero);
		return arg_crs1::encode(dec.rs1);
	}
	...
	/* Encode CI */
	template <typename T>
	inline uint64_t encode_ci(T &dec)
	{
		assert(dec.rd == dec.rs1);
		return arg_crs1rd::encode(dec.rs1) |
			arg_cimmi::encode(dec.imm);
	}

	/* Encode CI shamt5 */
	template <typename T>
	inline uint64_t encode_ci_sh5(T &dec)
	{
		assert(dec.rd == dec.rs1);
		return arg_crs1rd::encode(dec.rs1) |
			arg_cimmsh5::encode(dec.imm);
	}

	/* Encode CI shamt6 */
	template <typename T>
	inline uint64_t encode_ci_sh6(T &dec)
	{
		assert(dec.rd == dec.rs1);
		return arg_crs1rd::encode(dec.rs1) |
			arg_cimmsh6::encode(dec.imm);
	}

	/* Encode CI li */
	template <typename T>
	inline uint64_t encode_ci_li(T &dec)
	{
		assert(dec.rs1 == riscv_ireg_zero);
		return arg_crd::encode(dec.rd) |
			arg_cimmi::encode(dec.imm);
	...
	/* Encode CI lui */
	template <typename T>
	inline uint64_t encode_ci_lui(T &dec)
	{
		assert(dec.rs1 == riscv_ireg_zero);
		return arg_crd::encode(dec.rd) |
			arg_cimmui::encode(dec.imm);
	}

	/* Encode CI lwsp */
	template <typename T>
	inline uint64_t encode_ci_lwsp(T &dec)
	{
		assert(dec.rs1 == riscv_ireg_sp);
		return arg_crd::encode(dec.rd) |
			arg_cimmlwsp::encode(dec.imm);
	}

	/* Encode CI ldsp */
	template <typename T>
	inline uint64_t encode_ci_ldsp(T &dec)
	{
		assert(dec.rs1 == riscv_ireg_sp);
		return arg_crd::encode(dec.rd) |
			arg_cimmldsp::encode(dec.imm);
	}

	/* Encode CI 16sp */
	template <typename T>
	inline uint64_t encode_ci_16sp(T &dec)
	{
	...
	/* Encode CSS swsp */
	template <typename T>
	inline uint64_t encode_css_swsp(T &dec)
	{
		assert(dec.rs1 == riscv_ireg_sp);
		return arg_crs2::encode(dec.rs2) |
			arg_cimmswsp::encode(dec.imm);
	}

	/* Encode CSS sdsp */
	template <typename T>
	inline uint64_t encode_css_sdsp(T &dec)
	{
		assert(dec.rs1 == riscv_ireg_sp);
		return arg_crs2::encode(dec.rs2) |
			arg_cimmsdsp::encode(dec.imm);
	}

	/* Encode CIW 4spn */
	template <typename T>
	inline uint64_t encode_ciw_4spn(T &dec)
	{
		assert(dec.rs1 == riscv_ireg_sp);
		return arg_crdq::encode(dec.rd + 8) |
			arg_cimm4spn::encode(dec.imm);
	}

	/* Encode CL lw */
	template <typename T>
	inline uint64_t encode_cl_lw(T &dec)
	{
		return arg_crdq::encode(dec.rd + 8) |
			arg_crs1q::encode(dec.rs1 + 8)  |
			arg_cimmw::encode(dec.imm);
	}

	/* Encode CL ld */
	template <typename T>
	inline uint64_t encode_cl_ld(T &dec)
	{
		return arg_crdq::encode(dec.rd + 8) |
			arg_crs1q::encode(dec.rs1 + 8)  |
			arg_cimmd::encode(dec.imm);
	}

	/* Encode CS f */
	template <typename T>
	inline uint64_t encode_cs(T &dec)
	{
		assert(dec.rd == dec.rs1);
		return arg_crdq::encode(dec.rd + 8) |
			arg_crs1q::encode(dec.rs1 + 8);
	...
	/* Encode CS sd */
	template <typename T>
	inline uint64_t encode_cs_sd(T &dec)
	{
		return arg_crs1q::encode(dec.rs1 + 8)  |
			arg_crs2q::encode(dec.rs2 + 8) |
			arg_cimmd::encode(dec.imm);
	}

	/* Encode CS sw */
	template <typename T>
	inline uint64_t encode_cs_sw(T &dec)
	{
		return arg_crs1q::encode(dec.rs1 + 8)  |
			arg_crs2q::encode(dec.rs2 + 8) |
			arg_cimmw::encode(dec.imm);
	...
	/* Encode CB */
	template <typename T>
	inline uint64_t encode_cb(T &dec)
	{
		return arg_crs1q::encode(dec.rs1 + 8)  |
			arg_cimmb::encode(dec.imm);
	}

	/* Encode CB imm */
	template <typename T>
	inline uint64_t encode_cb_imm(T &dec)
	{
		assert(dec.rd == dec.rs1);
		return arg_crs1rdq::encode(dec.rs1 + 8)  |
			arg_cimmi::encode(dec.imm);
	}

	/* Encode CB shamt5 */
	template <typename T>
	inline uint64_t encode_cb_sh5(T &dec)
	{
		assert(dec.rd == dec.rs1);
		return arg_crs1rdq::encode(dec.rs1 + 8)  |
			arg_cimmsh5::encode(dec.imm);
	...
	/* Encode CB shamt6 */
	template <typename T>
	inline uint64_t encode_cb_sh6(T &dec)
	{
		assert(dec.rd == dec.rs1);
		return arg_crs1rdq::encode(dec.rs1 + 8)  |
			arg_cimmsh6::encode(dec.imm);
	...
	/* Encode CJ - imm */
	template <typename T>
	inline uint64_t encode_cj(T &dec)
	{
	...
	/* Encode R */
	template <typename T>
	inline uint64_t encode_r(T &dec)
	{
		return arg_rd::encode(dec.rd) |
			arg_rs1::encode(dec.rs1) |
			arg_rs2::encode(dec.rs2);
	}

	/* Encode R RM */
	template <typename T>
	inline uint64_t encode_r_m(T &dec)
	{
		return arg_rd::encode(dec.rd) |
			arg_rs1::encode(dec.rs1) |
			arg_rs2::encode(dec.rs2) |
			arg_rm::encode(dec.rm);
	}

	/* Encode R AMO Load */
	template <typename T>
	inline uint64_t encode_r_l(T &dec)
	{
		assert(dec.rs2 == 0);
		return arg_rd::encode(dec.rd) |
			arg_rs1::encode(dec.rs1) |
			arg_aq::encode(dec.aq) |
			arg_rl::encode(dec.rl);
	}

	/* Encode R AMO */
	template <typename T>
	inline uint64_t encode_r_a(T &dec)
	{
		return arg_rd::encode(dec.rd) |
			arg_rs1::encode(dec.rs1) |
			arg_rs2::encode(dec.rs2) |
	...
	/* Encode R 4f */
	template <typename T>
	inline uint64_t encode_r4_m(T &dec)
	{
		return arg_rd::encode(dec.rd) |
			arg_rs1::encode(dec.rs1) |
			arg_rs2::encode(dec.rs2) |
			arg_rs3::encode(dec.rs3) |
			arg_rm::encode(dec.rm);
	}

	/* Encode I */
	template <typename T>
	inline uint64_t encode_i(T &dec)
	{
		return arg_rd::encode(dec.rd) |
			arg_rs1::encode(dec.rs1) |
			arg_imm12::encode(dec.imm);
	}

	/* Encode I sh5 */
	template <typename T>
	inline uint64_t encode_i_sh5(T &dec)
	{
		return arg_rd::encode(dec.rd) |
			arg_rs1::encode(dec.rs1) |
			arg_shamt5::encode(dec.imm);
	}

	/* Encode I sh6 */
	template <typename T>
	inline uint64_t encode_i_sh6(T &dec)
	{
		return arg_rd::encode(dec.rd) |
			arg_rs1::encode(dec.rs1) |
			arg_shamt6::encode(dec.imm);
	}

	/* Encode S Store */
	template <typename T>
	inline uint64_t encode_s(T &dec)
	{
		return arg_rs1::encode(dec.rs1) |
			arg_rs2::encode(dec.rs2) |
			arg_simm12::encode(dec.imm);
	}

	/* Encode SB Branch */
	template <typename T>
	inline uint64_t encode_sb(T &dec)
	{
		return arg_rs1::encode(dec.rs1) |
			arg_rs2::encode(dec.rs2) |
			arg_sbimm12::encode(dec.imm);
	}

	/* Encode U */
	template <typename T>
	inline uint64_t encode_u(T &dec)
	{
		return arg_rd::encode(dec.rd) |
			arg_imm20::encode(dec.imm);
	}

	/* Encode UJ */
	template <typename T>
	inline uint64_t encode_uj(T &dec)
	{
		return arg_rd::encode(dec.rd) |
			arg_jimm20::encode(dec.imm);
	}
