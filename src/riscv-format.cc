...
const char* riscv_fmt_offset =                "o";
const char* riscv_fmt_rs1_rs2 =               "1,2";
const char* riscv_fmt_rd_imm =                "0,i";
const char* riscv_fmt_rd_offset =             "0,o";
...
const char* riscv_fmt_rd_rs1_offset =         "0,1,i";
const char* riscv_fmt_rd_offset_rs1 =         "0,i(1)";
const char* riscv_fmt_frd_offset_rs1 =        "3,i(1)";
const char* riscv_fmt_rd_csr_rs1 =            "0,c,1";
const char* riscv_fmt_rd_csr_imm5 =           "0,c,7";
const char* riscv_fmt_rs2_offset_rs1 =        "2,i(1)";
const char* riscv_fmt_frs2_offset_rs1 =       "5,i(1)";
const char* riscv_fmt_rs1_rs2_offset =        "1,2,o";
