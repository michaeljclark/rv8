...
const riscv_inst_comp_metadata riscv_comp_table[] = {
    ...
    { riscv_op_c_and,      riscv_inst_type_cs_f,          riscv_op_and,        riscv_inst_type_r },
    ...
    { riscv_op_c_fsd,      riscv_inst_type_cs_d,          riscv_op_fsd,        riscv_inst_type_sf },
    { riscv_op_c_fsdsp,    riscv_inst_type_css_sdsp,      riscv_op_fsd,        riscv_inst_type_sf },
    { riscv_op_c_addw,     riscv_inst_type_cs_f,          riscv_op_addw,       riscv_inst_type_r },
    { riscv_op_c_xor,      riscv_inst_type_cs_f,          riscv_op_xor,        riscv_inst_type_r },
    { riscv_op_c_or,       riscv_inst_type_cs_f,          riscv_op_or,         riscv_inst_type_r },
    { riscv_op_c_sub,      riscv_inst_type_cs_f,          riscv_op_sub,        riscv_inst_type_r },
    ...
    { riscv_op_c_subw,     riscv_inst_type_cs_f,          riscv_op_subw,       riscv_inst_type_r },
    ...
    { riscv_op_c_fsw,      riscv_inst_type_cs_w,          riscv_op_fsw,        riscv_inst_type_sf },
    { riscv_op_c_fswsp,    riscv_inst_type_css_swsp,      riscv_op_unknown,    riscv_inst_type_sf },
