...
const riscv_inst_comp_metadata riscv_comp_table[] = {
    ...
    { riscv_op_c_lw,       riscv_inst_type_cl_lw,         riscv_op_lw,         riscv_inst_type_i_l },
    ...
    { riscv_op_c_ld,       riscv_inst_type_cl_ld,         riscv_op_ld,         riscv_inst_type_i_l },
    ...
    { riscv_op_c_fld,      riscv_inst_type_cl_fld,        riscv_op_fld,        riscv_inst_type_i_lf },
    ...
    { riscv_op_c_fsd,      riscv_inst_type_cs_fsd,        riscv_op_fsd,        riscv_inst_type_s_f },
    ...
    { riscv_op_c_flw,      riscv_inst_type_cl_flw,        riscv_op_flw,        riscv_inst_type_i_lf },
    { riscv_op_c_flwsp,    riscv_inst_type_ci_lwsp,       riscv_op_flw,        riscv_inst_type_i_lf },
    { riscv_op_c_fsw,      riscv_inst_type_cs_fsw,        riscv_op_fsw,        riscv_inst_type_s_f },
