...
enum rv_op
{
	...
	rv_op_c_lqsp = 236,                
	rv_op_c_sqsp = 237,                
	rv_op_nop = 238,                   	/* No operation */
	rv_op_mv = 239,                    	/* Copy register */
	rv_op_not = 240,                   	/* One’s complement */
	rv_op_neg = 241,                   	/* Two’s complement */
	rv_op_negw = 242,                  	/* Two’s complement Word */
	rv_op_sext_w = 243,                	/* Sign extend Word */
	rv_op_seqz = 244,                  	/* Set if = zero */
	rv_op_snez = 245,                  	/* Set if ≠ zero */
	rv_op_sltz = 246,                  	/* Set if < zero */
	rv_op_sgtz = 247,                  	/* Set if > zero */
	rv_op_fmv_s = 248,                 	/* Copy single-precision register */
	rv_op_fabs_s = 249,                	/* Single-precision absolute value */
	rv_op_fneg_s = 250,                	/* Single-precision negate */
	rv_op_fmv_d = 251,                 	/* Copy double-precision register */
	rv_op_fabs_d = 252,                	/* Double-precision absolute value */
	rv_op_fneg_d = 253,                	/* Double-precision negate */
	rv_op_beqz = 254,                  	/* Branch if = zero */
	rv_op_bnez = 255,                  	/* Branch if ≠ zero */
	rv_op_blez = 256,                  	/* Branch if ≤ zero */
	rv_op_bgez = 257,                  	/* Branch if ≥ zero */
	rv_op_bltz = 258,                  	/* Branch if < zero */
	rv_op_bgtz = 259,                  	/* Branch if > zero */
	rv_op_j = 260,                     	/* Jump */
	rv_op_ret = 261,                   	/* Return from subroutine */
	rv_op_jr = 262,                    	/* Jump register */
	rv_op_rdcycle = 263,               	/* Read Cycle Counter Status Register */
	rv_op_rdtime = 264,                	/* Read Timer Status register */
	rv_op_rdinstret = 265,             	/* Read Instructions Retired Status Register */
	rv_op_rdcycleh = 266,              	/* Read Cycle Counter Status Register (upper 32-bits on RV32) */
	rv_op_rdtimeh = 267,               	/* Read Timer Status register (upper 32-bits on RV32) */
	rv_op_rdinstreth = 268,            	/* Read Instructions Retired Status Register (upper 32-bits on RV32) */
	rv_op_frcsr = 269,                 	/* Read FP Control and Status Register */
	rv_op_frrm = 270,                  	/* Read FP Rounding Mode */
	rv_op_frflags = 271,               	/* Read FP Accrued Exception Flags */
	rv_op_fscsr = 272,                 	/* Set FP Control and Status Register */
	rv_op_fsrm = 273,                  	/* Set FP Rounding Mode */
	rv_op_fsflags = 274,               	/* Set FP Accrued Exception Flags */
	rv_op_fsrmi = 275,                 	/* Set FP Rounding Mode Immediate */
	rv_op_fsflagsi = 276,              	/* Set FP Accrued Exception Flags Immediate */
};
