...
enum riscv_csr
{
	...
	riscv_csr_mcycle = 0xF00,           /* Machine cycle counter */
	riscv_csr_mtime = 0xF01,            /* Machine wall-clock time */
	riscv_csr_minstret = 0xF02,         /* Machine instructions-retired counter */
	riscv_csr_mcycleh = 0xF80,          /* Upper 32 bits of mcycle, RV32I only */
	riscv_csr_mtimeh = 0xF81,           /* Upper 32 bits of mtime, RV32I only */
	riscv_csr_minstreth = 0xF82,        /* Upper 32 bits of minstret, RV32I only */
