...
enum {
	...
	R_RISCV_ADD8 = 33,               /* 8,  8-bit label addition                                     word8  = S + A */
	R_RISCV_ADD16 = 34,              /* 16, 16-bit label addition                                    word16 = S + A */
	R_RISCV_ADD32 = 35,              /* 32, 32-bit label addition                                    word32 = S + A */
	R_RISCV_ADD64 = 36,              /* 64, 64-bit label addition                                    word64 = S + A */
	R_RISCV_SUB8 = 37,               /* 8,  8-bit label subtraction                                  word8  = S - A */
	R_RISCV_SUB16 = 38,              /* 16, 16-bit label subtraction                                 word16 = S - A */
	R_RISCV_SUB32 = 39,              /* 32, 32-bit label subtraction                                 word32 = S - A */
	R_RISCV_SUB64 = 40,              /* 64, 64-bit label subtraction                                 word64 = S - A */
