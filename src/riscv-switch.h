...
inline void riscv_decode_inst_type(T &dec, uint64_t inst)
{
	...
	switch (dec.codec) {
		...
		case riscv_codec_cb_sh6:        riscv_decode_cb_sh6(dec, inst);                    break;
		case riscv_codec_ci:            riscv_decode_ci(dec, inst);                        break;
		case riscv_codec_ci_sh5:        riscv_decode_ci_sh5(dec, inst);                    break;
		case riscv_codec_ci_sh6:        riscv_decode_ci_sh6(dec, inst);                    break;
...
inline uint64_t riscv_encode_inst(T &dec)
{
	...
	switch (dec.codec) {
		...
		case riscv_codec_cb_sh6:        return inst |= riscv_encode_cb_sh6(dec);           break;
		...
		case riscv_codec_ci_sh6:        return inst |= riscv_encode_ci_sh6(dec);           break;
